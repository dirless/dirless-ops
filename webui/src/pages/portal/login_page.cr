      ...
      body do
        div class: "auth-wrapper" do
          div class: "auth-card" do
            ...
            h1 "Sign in to your account", class: "auth-heading"
            ...
            form action: "/login", method: "post" do
              div class: "form-group" do
                ...
                input type: "email", id: "email", name: "email",
                  autofocus: "autofocus", autocomplete: "email", required: "required",
                  class: "form-input", placeholder: "you@company.com"
              end
              div class: "form-group" do
